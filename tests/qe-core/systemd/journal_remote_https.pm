...
sub run {
    ...
    assert_script_run("echo 'TrustedCertificateFile=-' >> $journal_upload_conf");
    #assert_script_run("echo 'TrustedCertificateFile=/etc/journal/ca/journal-ca-cert.pem' >> $journal_upload_conf");
    # TODO: cannot use together with --trust=all
