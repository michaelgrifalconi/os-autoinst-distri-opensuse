...
sub run {
    ...
    # Give ownership
    assert_script_run("chown systemd-journal-remote /etc/ssl/private/journal-remote.pem");
    ...
    # Give ownership
    assert_script_run("chown systemd-journal-upload /etc/ssl/private/journal-upload.pem");
